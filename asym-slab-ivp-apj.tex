...
\begin{equation}
v_x = -2 e^{k(x+x_0)} [\chi_{1+} \sin(\omega_{0+} t) + \chi_{1-} \sin(\omega_{0-} t)]  + \frac{1}{\rho_1} \int_{-\infty}^{-x_0} G_1(x;s) \left[ \Psi_0 \cos{kv_{A1}t} + i\frac{\partial \Psi_0}{\partial t} \frac{\sin{kv_{A1}t}}{kv_{A_1}} \right]ds.
\end{equation}
