...
\textcolor{red}{TO DO NEXT: Redo the above with the 4 poles, not just two. Evaluate final integral of equation~\eqref{sol incomp}. Repeat the above for other two regions of the slab. This gives us the full solution. Then maybe try to work out $\chi_{1,2}$. Test various initial conditions. Publish}
