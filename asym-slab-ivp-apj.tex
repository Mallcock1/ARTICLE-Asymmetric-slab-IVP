...
&= \frac{e^{k(x+x_0)}}{2\pi} \left( \lim_{L \to \infty} \int_{i\gamma - L}^{i\gamma + L} \tilde{A}_1 e^{-i\omega t} ds \right) + \frac{1}{2\pi} \left(\int_{-\infty}^{-x_0} G_1(x;s)f(s)ds \right) \left( \lim_{L \to \infty} \int_{i\gamma - L}^{i\gamma + L} \frac{e^{-i\omega t}}{\e_1} d\omega \right),
\label{sol incomp}
\end{align}
...
&= \frac{e^{k(x_0-x)}}{2\pi} \left( \lim_{L \to \infty} \int_{i\gamma - L}^{i\gamma + L} \tilde{A}_2 e^{-i\omega t} ds \right) + \left(\int_{-\infty}^{-x_0} G_2(x;s)f(s)ds \right) \left( \lim_{L \to \infty} \int_{i\gamma - L}^{i\gamma + L} \frac{e^{-i\omega t}}{\e_2} d\omega \right), \\
...
&= \textcolor{red}{CHANGE THIS AND BELOW EQN \frac{e^{k(x_0-x)}}{2\pi} \left( \lim_{L \to \infty} \int_{i\gamma - L}^{i\gamma + L} \tilde{A}_2 e^{-i\omega t} ds \right) + \left(\int_{-\infty}^{-x_0} G_2(x;s)f(s)ds \right) \left( \lim_{L \to \infty} \int_{i\gamma - L}^{i\gamma + L} \frac{e^{-i\omega t}}{\e_2} d\omega \right),} \\
&= \frac{2}{k} e^{k(x_0-x)} [\chi_{2+} \sin(\omega_{0+} t) + \chi_{2-} \sin(\omega_{0-} t)]  + \frac{\sin{kv_{A2}t}}{\rho_2 k v_{A2}} \left(\int_{-\infty}^{-x_0} G_2(x;s)f(s)ds \right).
\end{align}
