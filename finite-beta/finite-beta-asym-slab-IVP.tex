...
\begin{equation}
D_k(\omega) = -\frac{\rho_1\rho_2R}{m_0m_1m_2x_0} (\omega^2 - \omega_{sks}^2),
\end{equation}
where
\begin{equation}
...
&= - \frac{2m_0m_1m_2x_0\Lambda_1\Lambda_2}{\rho_1\rho_2Rm_0x_0}|_{\omega = \omega_{sks}} \frac{T_1(\omega_{sks})}{2\omega_{sks}D_s(\omega_{sks})} e^{i\omega_{sks}t} \\
